class Game {
  ...
  play(){
    ...
    if(allPlayers !== undefined){
      ...
      //index or position of the elements in array
      var index = 0;
      ...
      for(var plr in allPlayers){
        ...
        index = index+1;
        //position the cars a little way from each others in x position 
         x = x+200;
        //use data from daabase to display the cars in y position
